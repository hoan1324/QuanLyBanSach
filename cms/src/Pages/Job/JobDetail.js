...
function JobDetail({ data }) {
  return (
    ...
    >
      ...
      >
        <Descriptions.Item label="Tên công việc">{data.name}</Descriptions.Item>

        <Descriptions.Item label="Lương tối thiểu">
          {formatMoneyVn(data.salaryMin)}
        </Descriptions.Item>

        <Descriptions.Item label="Lương tối đa">
          {formatMoneyVn(data.salaryMax)}
        </Descriptions.Item>
